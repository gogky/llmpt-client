...
llmpt-cli daemon start --tracker http://your-tracker-server    # 指定 tracker
...
llmpt-cli stop model:gpt2@main                                # 停止指定模型的做种
llmpt-cli stop dataset:fka/prompts.chat@main                  # 停止指定数据集的做种
```
